...
function validateStep(step) {
    ...
    // Special validation for step 7 (email and phone)
    if (step === 7) {
...
function showSuccessMessage() {
    ...
    successDiv.innerHTML = `
        <div style="background-color: #d4edda; color: #155724; padding: 30px; border-radius: 8px; margin-top: 20px; border: 1px solid #c3e6cb; text-align: center;">
            ...
            <p style="margin-bottom: 0; font-size: 14px;">Our team will connect you with local gutter replacement contractors in your area shortly.</p>
        </div>
    `;
